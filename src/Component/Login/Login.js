...
const Login = () => {
    ...
    return (
        <div>
            <form className=" min-h-screen bg-base-200 pt-28" onSubmit={handleSubmit(onSubmit)}>
                <div className="">
                    <div className="rounded-lg w-4/4 sm:w-3/4 md:w-2/4 mx-auto  lg:w-2/4 xl:w-1/4 shadow-2xl bg-base-100">
                        ...
                        <div className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <label className="label">
                                    <p href="#" className=" label-text-alt link link-hover">Don't have an Account? <Link className='text-purple-600 hover:text-purple-600' to='/signUp'>SignUp</Link></p>
                                </label>
                            </div>
